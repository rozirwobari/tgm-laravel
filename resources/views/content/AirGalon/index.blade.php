    ...
    @if (Auth::user()->name != 'viewers')
        <div class="rzw-box-content">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <a href="{{ url('/qc_air_galon/input') }}" class="btn btn-primary w-100 rzw-btn-content">Input
                            Data</a>
                    </div>
                    <div class="col-12 pt-3">
                        <a href="{{ url('/qc_air_galon/export') }}" class="btn btn-primary w-100 rzw-btn-content"
