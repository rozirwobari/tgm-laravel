...
@section('content')
    ...
    <form action="{{ url('/qc_air_galon/edit/' . $details->id) }}" method="POST">
        @csrf
        <div class="rzw-box-content">
            <div class="card-body">
    ...
    @if ($details->status == 0 && Auth::user()->role->name == 'manager')
        <div class="rzw-box-content">
            <div class="row">
                <div class="col-6">
                    <a class="btn btn-primary w-100" href="{{ url('qc_air_galon/reject/' . $details->id) }}"
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <a class="btn btn-primary w-100" href="{{ url('qc_air_galon/approve/' . $details->id) }}"
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ url('qc_air_galon/delete') }}" + "/" + id;
                }
            });
        }
    </script>
