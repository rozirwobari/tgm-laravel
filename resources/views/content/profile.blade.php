    ...
    <form action="{{ url('profile') }}" method="post" enctype="multipart/form-data" id="profileForm">
        ...
        <div class="rzw-box-profile" style="margin-top: 10%;">
            ...
            <div class="card-body">
                ...
                <div class="input-group my-3">
                    <input type="text" class="form-control rzw-input @error('nama') is-invalid @enderror"
            ...
            <div class="card-body">
                ...
                <div class="input-group my-3">
                    <select class="form-control rzw-input @error('role') is-invalid @enderror"
                        name="role" id="role" required>
                        <option value="">Pilih Role</option>
                        @foreach ($roles as $role)
                            <option value="{{ $role->id }}" {{ Auth::user()->role_id == $role->id ? 'selected' : '' }}>{{ $role->label }}</option>
                        @endforeach
                    </select>
                    <div class="input-group-prepend">
                        <span class="rzw-icon-input" style="z-index: 5;">
            ...
            <div class="card-body">
                ...
                <div class="input-group my-3">
                    <input type="text" class="form-control rzw-input @error('password_lama') is-invalid @enderror" name="password_lama" id="password_lama" placeholder="Password Lama">
                    <div class="input-group-prepend">
                    <span class="rzw-icon-input" style="z-index: 5;">
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-cursor-text"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 12h4" /><path d="M9 4a3 3 0 0 1 3 3v10a3 3 0 0 1 -3 3" /><path d="M15 4a3 3 0 0 0 -3 3v10a3 3 0 0 0 3 3" /></svg>
                    </span>
            ...
            <div class="card-body">
                ...
                <div class="input-group my-3">
                    <input type="text" class="form-control rzw-input @error('password_baru') is-invalid @enderror" name="password_baru" id="password_baru" placeholder="Password Baru">
                    <div class="input-group-prepend">
                    <span class="rzw-icon-input" style="z-index: 5;">
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-cursor-text"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 12h4" /><path d="M9 4a3 3 0 0 1 3 3v10a3 3 0 0 1 -3 3" /><path d="M15 4a3 3 0 0 0 -3 3v10a3 3 0 0 0 3 3" /></svg>
                    </span>
            ...
            <div class="card-body">
                ...
                <div class="input-group my-3">
                    <input type="file" class="form-control @error('foto_profile') is-invalid @enderror" name="foto_profile" id="foto_profile" placeholder="Profile Picture" onchange="readURL(this);">
                    <div id="validationServerUsernameFeedback" class="invalid-feedback text-start">
                        @error('foto_profile')
                            {{ $message }}
                        @enderror
                ...
                <div class="text-center">
                    <img src="{{ asset(Auth::user()->img ?? 'asset/img/profile.png') }}" alt="Login Icon" class="rzw-profile-img" id="profileImg">
                </div>
            </div>
