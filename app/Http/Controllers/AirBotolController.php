...
class AirBotolController extends Controller
{
    ...
    {
        $data = QcAirBotol::orderBy('created_at', 'desc')->get();
        return view('content.AirBotol.index', compact('data'));
    }
    ...
    {
        return view('content.AirBotol.input');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('qc_air_botol')->with('alert', [
            'type' => 'success',
    ...
    {
        $details = DB::table('qc_air_botol')->where('id', $id)->first();
        return view('content.AirBotol.detail', compact('details'));
    }
    ...
    private function findEmptyRow($client, $sheetName)
    {
        try {
            ...
            $response = $service->spreadsheets_values->get($this->sheetId, $sheetName.'!G7:G');
    ...
    public function approve(string $id)
    {
        ...
        try {
            ...
            $sheetName = "QC Air Botol ".date('F Y', time());
    ...
    public function export()
    {
        ...
        $WorkSheetName = 'QC Air Botol '.date('F Y', time());
        ...
        $fileName = 'qc_air_botol_'.date('Y-m-d_His').'.xlsx';
