...
class AirCupController extends Controller
{
    ...
    {
        $data = QcAirCup::orderBy('created_at', 'desc')->get();
        return view('content.AirCup.index', compact('data'));
    }
    ...
    {
        return view('content.AirCup.input');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('qc_air_cup')->with('alert', [
            'type' => 'success',
    ...
    {
        $details = DB::table('qc_air_cup')->where('id', $id)->first();
        return view('content.AirCup.detail', compact('details'));
    }
    ...
    public function approve(string $id)
    {
        ...
        try {
            ...
            $sheetName = "QC Air Cup ".date('F Y', time());
    ...
    public function export()
    {
        ...
        $WorkSheetName = 'QC Air Cup '.date('F Y', time());
        ...
        $fileName = 'qc_air_cup_'.date('Y-m-d_His').'.xlsx';
